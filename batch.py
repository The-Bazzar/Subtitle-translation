"""Stage-aware batch entry point through translation and optional burn."""
...
async def _run_stage_command(
    ...
    *,
    ...
    stdout = terminal.stage_output(task_index, stage, "stdout")
    stderr = terminal.stage_output(task_index, stage, "stderr")
